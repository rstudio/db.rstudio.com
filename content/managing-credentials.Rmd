...
The ability to share code with others is one of the most compelling features of R.  **When a database connection is part of the R script, it it very important to avoid leaving the credentials as plain text**.  In this article, we will cover five options to make sure credentials are safely passed to the database.  Starting with the best method at the top, we will cover the following:
