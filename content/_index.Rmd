...
- **Integration with RStudio.**  RStudio 1.1 helps you write the R code you need to connect to a database, remembers connections you've made, and allows you to explore the objects and data in your database.

- **Education is key.** This website is the main way we provide support in this area. It gathers Best Practices, How-to articles and other helpful resources in one location.  RStudio is also working through other delivery channels, like upcoming webinars and in-person training at **[rstudio::conf 2018](https://www.rstudio.com/conference/)** 
