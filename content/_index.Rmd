...
The RStudio **Connections Pane** makes it possible to easily connect to a variety of data sources, and explore the objects and data inside the connection. It extends, and is designed to work with, a variety of other tools for working with databases in R. 
...
Preview the first 1,000 records in a database by simply clicking on the table icon 
