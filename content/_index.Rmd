...
If the database you are interested in working with is not listed here yet, then you can still use `DBI` and `odbc` to connect and send SQL queries.  If you would like to contribute a translation, please see the [SQL Translation](translation) page in this website.
...
<center><img src="/homepage/odbc.png"  height="270" width="450" align="middle"></center>
...
More examples are available on the left menu under the **Examples** section.
