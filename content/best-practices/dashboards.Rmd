...
1. **A dashboard plot or table is clicked.**  The value that user clicks on is usually aggregated data.
1. **A new screen is displayed with another report.** The new report could display a lower-level aggregation, or row level table.
