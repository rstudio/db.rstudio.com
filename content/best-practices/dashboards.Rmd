...
- [local_app.R](https://github.com/sol-eng/db-dashboard/blob/master/local_app.R) - Example that works without a database connection.  

- [db_app.R](https://github.com/sol-eng/db-dashboard/blob/master/db_app.R) - Full example, it shows how it connects to a database.
