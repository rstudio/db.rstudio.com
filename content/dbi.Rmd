...
There are two ways that DBI connects to a database.  The first way is to use a **community supported R package** that connect to a specific type of database.  Here are the most commonly used packages: 
...
The second way that DBI connects to a database is by using the **ODBC driver**.  Most commercialy available databases provide their own ODBC driver.  
