...
### Installation
 ...
 1. Install [homebrew](http://brew.sh/) can be used to easily install database drivers on MacOS.

 2. Install UnixODBC - Required for all databases
```shell
...
drivers on Linux distributions which support it, such as Debian and Ubuntu.
 ...
 1. Install UnixODBC - Required for all databases
...
It contains the driver information, particularly the name of the driver library.
...
It contains the connection information, particularly the username, password, database
