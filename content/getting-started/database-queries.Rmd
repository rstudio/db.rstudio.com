...
* [RStudio IDE (v1.1)](/connections). With the latest version of the RStudio IDE, you can connect to, explore, and view data in a variety of databases. The IDE has a wizard for setting up new connections, and a tab for exploring established connections. These new features are extensible and will work with any R package that has a [connections contract](/advanced/contract/).
* [RStudio Professional Drivers](/rstudio/pro-drivers/). If you are using RStudio professional products, you can download RStudio Professional Drivers for no additional cost. The examples below use the Oracle ODBC driver. If you are using open-source tools, you can bring your own driver or use community packages -- many open-source drivers and community packages exist for connecting to a variety of databases.
